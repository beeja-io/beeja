...
const Timesheet: React.FC = () => {
  ...
  >([]);
  useEffect(() => {
    if (selectedProject !== 'All' || selectedContract !== 'All') {
      setSelectedView('day');
    } else {
  ...
  const addNewEntry = () => {
    setLogEntries([
      ...logEntries,
      { project: '', contract: '', hours: '', description: '' },
    ]);
  };
        ...
        {logEntries.map((entry, index) => (
          <div key={index} className="Form_Row">
            ...
            <input
              ...
              onChange={(e) =>
                handleInputChange(index, 'contract', e.target.value)
              }
            />
            <input
              type="number"
              ...
              value={entry.hours}
              onChange={(e) =>
                handleInputChange(index, 'hours', Number(e.target.value))
              }
            />
            <textarea
          ...
          {weekTimesheetData.map((entry, index) => (
            <div key={index}>
              <TimesheetRow onClick={() => toggleWeek(entry.week)}>
                ...
                <span>
                  Weekly Logged Hours: {entry.hours} hrs
