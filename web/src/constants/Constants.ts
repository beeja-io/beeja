...
export const ERR_ACCOUNT_NOT_FOUND_TEXT =
...
export const PersonalLoanTermsAndConditions =
  'https://docs.google.com/document/d/1lkziD462Ikxd32DS4Psahn2T5_w4W4BXsR5Z4Gv6-Ec/edit#heading=h.ktn2berq0p2o';

export const minDateOfFromCalendar = new Date('01-20-2023');

// ERROR CODES
export const ERR_ACCOUNT_NOT_FOUND = 'NAF';

export const PreviewReceiptError =
