...
interface Props {
  ...
  options?: { value: string; label: string; color: string; bgColor: string }[]; // ✅ add this line
}

const FeedbackStatusDropdown: React.FC<Props> = ({
  value,
  onChange,
  disabled,
}) => {
  ...
  const selected = FeedbackStatus.find((s) => s.value === value);
