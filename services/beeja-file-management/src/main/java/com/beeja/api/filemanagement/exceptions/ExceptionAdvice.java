...
public class ExceptionAdvice {
  ...
  public ResponseEntity<ErrorResponse> handleGlobalExceptionHandler(GlobalExceptionHandler e, WebRequest request) {
  ...
  public ResponseEntity<ErrorResponse> handleUnAuthorisedException(UnAuthorisedException e,WebRequest request) {
    String[] errorMessage = convertStringToArray(e.getMessage());
    ErrorResponse errorResponse =
            new ErrorResponse(
                    ErrorType.valueOf(errorMessage[0]),
  ...
  public ResponseEntity<ErrorResponse> handleFileNotFoundException(FileNotFoundException e,WebRequest request) {
    String[] errorMessage = convertStringToArray(e.getMessage());
    ErrorResponse errorResponse =
            new ErrorResponse(
                    ErrorType.valueOf(errorMessage[0]),
