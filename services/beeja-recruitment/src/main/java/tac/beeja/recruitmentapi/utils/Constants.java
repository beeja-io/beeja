...
public class Constants {
  ...
  public static final String NO_APPLICANT_FOUND_WITH_GIVEN_ID =
      "No Applicant found with given ID : ";
  ...
  public static final String ERROR_IN_SAVING_UPDATED_APPLICANT =
      "Error in Saving Updated Applicant";
  public static final String INTERVIEWER_ALREADY_ASSIGNED =
      "Interviewer already assigned to this applicant";
  public static final String INTERVIEWER_PERMISSION_FETCH_FAILED =
      "Error in fetching interviewer permission, please check interviewer Employee ID";
  public static final String INTERVIEWER_PERMISSION_DENIED =
      "Interviewer does not have the required permission";
  ...
  public static final String NO_INTERVIEWER_ASSIGNED =
      "No interviewer assigned to applicant with ID: ";
  ...
  public static final String UNAUTHORISED_RESUME_ACCESS =
      "Unauthorized access attempt to download file with ID:";
  public static final String GET_FILE_METADATA_FAILED =
      "Error while fetching file metadata for file ID:";
  public static final String FILE_DOWNLOAD_FAILED = "Error while downloading file with ID: ";
  public static final String ERROR_FETCH_FILE_METADATA =
      "Error while fetching file metadata for fileId: ";
  public static final String ERROR_IN_DOWNLOAD_FILE = "Error while downloading file for fileId : ";
  public static final String DUPLICATE_APPLICANT =
      "Applicant already applied for this position in the last 6 months.";
  public static final String DUPLICATE_APPLICATION_LOG =
      "Duplicate application within 6 months detected for email: {} and position: {}";
}
