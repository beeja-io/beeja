...
public class InvoiceServiceImpl implements InvoiceService {
    ...
    public Invoice generateInvoiceForContract(String contractId, InvoiceRequest request) {
        ...
        String prefix = orgName.length() >= 3 ? orgName.substring(0, 3).toUpperCase() : orgName.toUpperCase();
        ...
        Client client = clientRepository.findByClientIdAndOrganizationId(
                invoice.getClientId(),
