...
public class Constants {
  ...
  public static final String TAX_ID_MISSING = "No Tax ID available (both org and request empty)";
  public static final String INVOICE_UPLOAD_FAILED = "Invoice uploaded failed";
}