...
public class ContractsControllerTest {
    ...
    public void testGetContractsByProject() {
        ...
        ResponseEntity<List<Contract>> responseEntity = contractsController.getContractsByProject(projectId);
    ...
    public void testUpdateContract() {
        ...
        ResponseEntity<Contract> responseEntity = contractsController.updateContract(contractId, contractRequest);
