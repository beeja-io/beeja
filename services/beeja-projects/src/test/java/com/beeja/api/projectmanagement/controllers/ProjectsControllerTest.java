...
public class ProjectsControllerTest {
    ...
    public void testGetProjectsByClientId() {
        ...
        ResponseEntity<List<Project>> responseEntity = projectsController.getProjectsByClientId(clientId);
    ...
    public void testUpdateProject() {
        ...
        when(projectService.updateProjectByProjectId(projectRequest, projectId)).thenReturn(updatedProject);

        ResponseEntity<Project> responseEntity = projectsController.updateProject(projectId, projectRequest);
