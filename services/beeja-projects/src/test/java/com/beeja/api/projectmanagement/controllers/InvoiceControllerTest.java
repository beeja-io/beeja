...
public class InvoiceControllerTest {
  ...
  void setUp() {
    UserContext.setLoggedInUser(
        ...
        Set.of(
            PermissionConstants.CREATE_INVOICE,
            PermissionConstants.GET_INVOICE,
            PermissionConstants.UPDATE_STATUS_INVOICE),
        "test-token");
  ...
  void createInvoice_Success() {
    ...
    verify(invoiceService, times(1))
        .generateInvoiceForContract(invoiceRequest.getContractId(), invoiceRequest);
  }
        ...
        .thenThrow(
            new ResourceNotFoundException(
                new ErrorResponse(
                    ...
                    "Invoice not found",
                    "/v1/invoices/nonExistentInvoiceId")));
  ...
  void getInvoicesByContractId_Success_WithInvoices() {
    ...
    ResponseEntity<List<Invoice>> response =
        invoiceController.getInvoicesByContractId("contract123");
  ...
  void getInvoicesByContractId_Success_NoInvoices() {
    ...
    ResponseEntity<List<Invoice>> response =
        invoiceController.getInvoicesByContractId("contract456");
        ...
        .thenThrow(
            new ResourceNotFoundException(
                new ErrorResponse(
                    ErrorType.NOT_FOUND,
                    ErrorCode.RESOURCE_NOT_FOUND,
                    "Invoice not found to mark as paid",
                    "/v1/invoices/nonExistentInvoiceId/mark-paid")));
