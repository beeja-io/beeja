...
public enum ErrorCode {
    ...
    EXPENSE_ALREADY_SETTLED, INVALID_PAGINATION_PARAMS, EXPENSE_FILTERING_FAILED, EXPENSE_DEFAULT_FETCH_FAILED, FILE_SERVICE_COMMUNICATION_FAILED, FILE_DOWNLOAD_FAILED, ERROR_SAVING_FILE
}
